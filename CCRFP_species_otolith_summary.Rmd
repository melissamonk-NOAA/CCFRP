...
---
title: "CCFRP Otolith Collections"
...
Looking at species (Table \@ref(tab-collections)).


```{r collections, echo = FALSE}
table.index <- kableExtra::kbl(collections_final,
  booktabs = TRUE,
  caption = paste0(
    "Suggested otolith collections for 2022 CCFRP by species and partner"
  ),
