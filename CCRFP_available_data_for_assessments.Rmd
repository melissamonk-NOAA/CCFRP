...
```{r lengths, fig.cap = paste("Density plot of",names(plot_list), "fork length bins encountered inside each MPA and outside at reference areas (REF) A sample size of NA indicates fewer than 20 fish were encountered in that MPA stratum and were not plotted."), echo=FALSE, warning= FALSE, results = "asis"}
